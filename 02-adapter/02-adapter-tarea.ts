...
class MercadoPagoService {
  pay(amount: number): void {
    console.log(
      `Procesando pago de $${amount} con %cMercadoPago`, COLORS.yellow
    );
  }
}
...
class PayPalAdapter implements PaymentProcessor {
  // TODO: Implementar la clase adaptadora para PayPal
}

// Adaptador para Stripe
class StripeAdapter implements PaymentProcessor {
  // TODO: Implementar la clase adaptadora para Stripe
}

// Adaptador para MercadoPago
class MercadoPagoAdapter implements PaymentProcessor {
  // TODO: Implementar la clase adaptadora para MercadoPago
}
